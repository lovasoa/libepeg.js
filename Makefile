...
epeg.js:  js/post.js libepeg/libepeg.o epeg/epeg.o libjpeg/build-emscripten/.libs/libjpeg.so  
	emcc -O3 -s TOTAL_MEMORY=67108864 -s EXPORTED_FUNCTIONS="['_create_thumbnail']" libepeg/libepeg.o epeg/epeg.o libjpeg/build-emscripten/.libs/libjpeg.so --post-js js/post.js -o epeg.js
